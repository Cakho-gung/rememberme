      ...
      <div class="title-section {isDropdownOpen ? 'expanded' : ''}">
        ...
        <div class="title-row">
          ...
          <button class="title-icon-btn" onclick={toggleCollapse} aria-label="Toggle Collapse">
            <svg class="title-icon" class:collapsed={isCollapsed} width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M7.66988 5.49915C7.90277 5.34536 8.21875 5.37127 8.42378 5.5763L12.4238 9.5763C12.6581 9.81062 12.6581 10.1896 12.4238 10.424C12.1895 10.6583 11.8104 10.6583 11.5761 10.424L7.99995 6.84779L4.42378 10.424C4.18947 10.6583 3.81044 10.6583 3.57613 10.424C3.34181 10.1896 3.34181 9.81062 3.57613 9.5763L7.57613 5.5763L7.66988 5.49915Z" fill="currentColor"/>
            </svg>
          </button>
